...
ax7 . scatter ( data [:, 3], data [:,0 ], c = cols)
ax8 . scatter ( data [:,3], data [ :,1], c = cols)
ax9 . scatter ( data [: ,2], data [ :,0 ], c = cols)
ax10 . scatter ( data [:, 2 ], data [:, 3 ], c = cols)
ax11 . scatter ( data [:, 2 ], data [:, 1 ], c = cols)
